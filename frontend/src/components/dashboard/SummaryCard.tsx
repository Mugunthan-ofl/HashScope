...
export const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  if (badgeType === 'danger') badgeClasses = 'bg-[#3b0a0a] text-red-400 border-red-900/60';
  if (badgeType === 'warning') badgeClasses = 'bg-[#3b200a] text-amber-400 border-amber-900/60';
  if (badgeType === 'success') badgeClasses = 'bg-[#092e26] text-[#10b981] border-[#10b981]/40';
  ...
  return (
    <div className="bg-[#101719] border border-[#1b282a] rounded-xl p-5 space-y-3 shadow-sm hover:border-[#233538] transition-colors">
      ...
      <div className="flex items-baseline justify-between pt-1">
        ...
        {badgeText && (
          <span className={`text-[11px] px-2 py-0.5 rounded border font-mono ${badgeClasses}`}>
            {badgeText}
          </span>
        )}
      </div>
